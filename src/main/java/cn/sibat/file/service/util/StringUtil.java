...
public class StringUtil {
    ...
    public static int stringToInt(String str, int defaultValue) {
        ...
        if (isInt(str)) {
            ...
            logger.info(new Date() + " stringToInteger is fail");
            return defaultValue;
        }
    }
    ...
    public static double stringToDouble(String str, double defaultValue) {
        ...
        try {
            ...
            logger.info(new Date() + " stringToDouble is fail");
            return defaultValue;
        }
    }
    ...
    public static float stringToFloat(String str, float defaultValue) {
        ...
        try {
            ...
            logger.info(new Date() + " stringToFloat is fail");
            return defaultValue;
        }
    }
    ...
    public static long stringToLong(String str, long defaultValue) {
        ...
        try {
            ...
            logger.info(new Date() + " stringToLong is fail");
            return defaultValue;
        }
    }
